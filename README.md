...
| [camscanner-extract-formula](skills/camscanner-extract-formula/SKILL.md) | Extract mathematical formulas from images, crop and stitch into a single clean PNG. | PNG |
| [camscanner-image-hd](skills/camscanner-image-hd/SKILL.md) | Enhance image clarity and quality with auto-crop and HD super filter. Optionally removes moire patterns. | JPEG |
| [camscanner-translate-image](skills/camscanner-translate-image/SKILL.md) | Translate text in images to another language while preserving the original layout. | PNG |
| [camscanner-image-erase-handwriting](skills/camscanner-image-erase-handwriting/SKILL.md) | Erase handwriting, annotations, and signatures from images while preserving the printed content. | Image (.jpg) |
| [camscanner-image-remove-watermark](skills/camscanner-image-remove-watermark/SKILL.md) | Remove watermarks, stamps, and translucent logos from images while preserving the underlying content. | Image (.jpg) |
| [camscanner-pdf-remove-watermark](skills/camscanner-pdf-remove-watermark/SKILL.md) | Remove watermarks, stamps, and translucent logos from PDF documents while preserving the underlying content. | PDF (.pdf) |
| [camscanner-image-detect-tampering](skills/camscanner-image-detect-tampering/SKILL.md) | Detect whether an image has been PS-edited, spliced, or otherwise tampered with. Returns a JSON verdict. | JSON result |
| [camscanner-image-detect-aigc](skills/camscanner-image-detect-aigc/SKILL.md) | Detect whether an image was generated by an AI model (Stable Diffusion, Midjourney, etc.). Returns a JSON verdict with confidence. | JSON result |
...
- "Extract formulas from this image"
- "Make this image clearer / HD"
